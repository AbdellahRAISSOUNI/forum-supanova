                    ...
                    <div className="flex-shrink-0">
                      {company.imageUrl ? (
                        <img
                          ...
                          className="w-12 h-12 md:w-16 md:h-16 rounded-lg object-cover border border-slate-200"
                          onError={(e) => {
                      ...
                      <div className={`w-12 h-12 md:w-16 md:h-16 rounded-lg bg-slate-100 flex items-center justify-center border border-slate-200 ${company.imageUrl ? 'hidden' : ''}`}>
