 ...
 * Uses the native MongoDB driver for more reliable connections
 */
...
async function nativeMigration(): Promise<void> {
  console.log('🚀 Native MongoDB Migration');
  ...
  try {
    ...
    console.log('   5. Create admin user if needed: npm run seed:admin');
